<?php
/**
 * Template for Exhibitions category archive
 *
    ...
    <div class="archive-layout">
        <aside class="archive-sidebar">
            <nav class="archive-submenu">
                <h3 class="submenu-title"><?php esc_html_e('Exhibitions', 'wqs-portfolio'); ?></h3>
        ...
        <div class="archive-content">
            <header class="archive-header" data-aos="fade-up">
                <h1><?php esc_html_e('Exhibitions', 'wqs-portfolio'); ?></h1>
                <p class="archive-description">
                    <?php esc_html_e('Exhibition history', 'wqs-portfolio'); ?>
                </p>
            </header>
            ...
            <?php else :
                echo '<p class="no-results">' . esc_html__('No exhibitions found.', 'wqs-portfolio') . '</p>';
            endif; ?>
        </div>
    </div>
</main>
