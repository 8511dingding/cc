<?php
/**
 * Archive template with sidebar for category filtering
 *
    ...
    <div class="archive-layout">
        <aside class="archive-sidebar">
            <nav class="archive-submenu">
                <h3 class="submenu-title"><?php echo esc_html(single_term_title('', false)); ?></h3>
                <ul class="submenu-list">
                    ...
                    <?php
                    // Get unique years from posts in this category
                    global $wp_query;
                    $years = array();
