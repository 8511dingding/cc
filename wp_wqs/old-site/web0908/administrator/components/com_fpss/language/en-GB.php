...
// Copyrights
define('_FPSS_ABOUT','Find out more about "Frontpage SlideShow" at the official JoomlaWorks website or visit the exclusive product website at frontpageslideshow.<br /><br />Copyright &copy 2006 - '.date('Y').'. All Rights Reserved. This code cannot be redistributed without permission from JoomlaWorks.<br /><br />Designed and developed by the JoomlaWorks team.<br /><br /><i>(Last update: September 1st, 2008 - v2.0.0)</i>');
define('_FPSS_COPYRIGHTS','Frontpage Slideshow v2.0.0 | Copyright &copy; 2006-'.date('Y').'. All Rights Reserved.');
