...
<?php if ($this->item->params->get('show_readmore') || $this->item->params->get('show_author') || $this->item->params->get('show_modify_date') || $this->item->params->get('show_create_date')) : ?>
...
<?php if ( intval($this->item->modified) != 0 && $this->item->params->get('show_modify_date')) : ?>
	<span class="modifydate">
		<?php echo JText::_( 'Last Updated' ); ?> ( <?php echo JHTML::_('date', $this->item->modified, JText::_('%d %b %Y')); ?> )
	</span>
<?php endif; ?>
