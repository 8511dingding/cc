...
body{text-align:center; padding:0; margin:7px 0 14px 0; font-family:Verdana,Arial,Helvetica,sans-serif; color:#333;  line-height:15px; background-color:#FFF}
...
.small, .mosimage_caption{text-transform:uppercase; font:10px Tahoma,Verdana,"Lucida Sans"}
.clr{clear:both; height:1px}
.input{border:0}
.contentdescription img{padding:5px; margin:15px}
.contentheading, 
.contentheading a:link, 
.contentheading a:visited{text-align:left; margin:0 0 7px 0; padding:15px 0 25px 10px; font:bold 13px "Times New Roman",Times,serif; text-transform:uppercase}
.contentheading a:hover{text-decoration:underline}
.componentheading{letter-spacing:normal; font-size:18px; margin:0 0px 4px 0px; padding:0px 0 25px 10px; font:bold 15px "Times New Roman",Times,serif}
...
.button, .validate{width:80px; height:19px; padding:0 0 3px 0; border:0; text-transform:lowercase; letter-spacing:0.5px; font-size:10px; font-weight:bold}
