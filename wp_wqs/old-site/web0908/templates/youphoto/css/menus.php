...
#top_menu{width:100%; margin:0 auto; display:block; position:relative; z-index:10000; background:#fff}
#horiznav{height:56px; z-index:500; float:none; margin:0 15px}
#horiznav ul{list-style:none; line-height:56px; padding-top:0px}
#horiznav ul li{position:relative; margin:0}
#horiznav a{text-transform:uppercase; display:block; cursor:pointer; height:56px; padding:0px 0px 0px 25px; margin:0px 0px 0px 0px; font:bold 10px/56px Tahoma}
#horiznav li a:hover{height:56px}
...
#horiznav li ul{position:absolute; left:-999em; height:auto; font-weight:normal; border-width:0; margin:-1px 0 0 0px; padding:0; border-bottom:none}
...
#top_menu_d{width:100%; margin:0 auto; display:block; position:relative; z-index:10000; background:#fff}
#horiznav_d{height:56px; position:relative; display:block; position:relative; padding:0px; margin:0 15px; overflow:hidden; background:#dbdbdb}
#horiznav_d a{white-space:nowrap; display:block; float:left; text-transform:uppercase; cursor:pointer; height:56px; padding:0px 25px 0px 25px; margin:0px 0px 0px 0px; font:bold 10px/56px Tahoma}
#horiznav_d ul{margin:0; padding-top:0px; line-height:56px; float:left}
#horiznav_d ul ul ul{left:-20000px}
#horiznav_d li{padding:0; margin:0 0px 0 0; float:left; display:block}
#horiznav_d li ul{display:none; margin:0 auto; padding:0; position:absolute; top:56px; height:56px; overflow:hidden; left:0; width:100%}
...
#horiznav_d li a, #horiznav_d li .separator{font:bold 10px/56px Tahoma; text-transform:uppercase}
...
#mainlevel li, 
.menu li, 
.menu li:hover{background-image:none;background-color:#DCD6A5;}
#mainlevel li a, 
.menu li a{height:26px; text-decoration:none; display:block; font:italic bold 12px/20px "Times New Roman",Times,serif; letter-spacing:1px; text-decoration:none; text-indent:22px; padding-top:5px}

a.mainlevel{display:block; width:100%; height:26px; font:italic bold 12px/20px "Times New Roman",Times,serif; letter-spacing:1px; padding-top:5px; text-decoration:none; text-indent:24px}
a.sublevel{display:block; padding:2px 4px 0px 15px; text-decoration:none; font:italic bold 12px/20px "Times New Roman",Times,serif; letter-spacing:1px}
a.sublevel:hover, 
a.sublevel:active, 
