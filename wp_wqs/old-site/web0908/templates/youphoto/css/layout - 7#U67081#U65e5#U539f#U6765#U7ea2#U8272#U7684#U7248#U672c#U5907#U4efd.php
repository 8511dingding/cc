...
#header{text-align:left; height:111px; position:relative}
#logo{height:111px; width:433px; float:left; text-align:left}
...
#banner{height:70px; float:right; margin:12px 5px 0 0; overflow:hidden; width:499px; text-align:center; padding:5px 0 0 0}

.search{}
.search .inputbox{}
#pathway{margin:5px 15px; padding:3px 0px}
...
#holder{width:900; height:100% !Important; height:1%; overflow:hidden; margin:0 auto; text-align:center; margin:0 5px 0 5px}
#leftblock{float:left; width:115; height:100% !Important; height:1%; overflow:hidden; text-align:left}
#midblock{float:left; width:790; height:100% !Important; height:1%; overflow:hidden; text-align:left; margin:8px -3px 0 0px}
#rightblock{float:left; width:1; height:100% !Important; height:1%; overflow:hidden; text-align:left}
/*#rightblock{float:left; width:1; height:100% !Important; height:1%; overflow:hidden; text-align:left}*/

.inside{padding:0 5px; overflow:hidden}
...
#footer a{color:#E26F36;}
#footer a:hover{color:#DCD6A5;}
...
.news_item_f{margin:0 5px; position:relative; overflow:hidden}
.news_item_c{margin:0 5px; position:relative; overflow:hidden}
.news_item_s{margin:0 5px; position:relative; overflow:hidden}
.news_item_a{margin:0px 0px 0 0px!Important; background:none; padding:0px; overflow:hidden}
.news_item_a .contentheading{margin:-15px 0 0 0}
...
.newsitems_link{}
.newsitem_text{display:block; padding:0px 10px 15px 10px !Important; overflow:hidden; clear:both}
...
.news_item_article{padding:0px 0 0 0!Important}
...
.yjsquare h3, 
.yjsquare_yj1 h3, 
.yjsquare_yj2 h3{text-transform:capitalize; overflow:hidden; font:italic bold 14px "Times New Roman",Times,serif; padding:15px 0 25px 10px; margin:0px}
.yjsquare_yj2 h3{margin:0; padding:15px 0 0px 10px; background:none}
.yjsquare h3 span, 
.yjsquare_yj1 h3 span, 
.yjsquare_yj2 h3 span{text-transform:capitalize; overflow:hidden}
.yjsquare p, 
.yjsquare_yj1 p, 
...
.yjsquare, 
.yjsquare_yj1, 
.yjsquare_yj2{margin:13px 0 0px 0px; padding:0px; clear:both; display:block; height:100% !Important; height:1%; overflow:hidden}
...
#advert1{margin:0 15px 0px 15px; padding:17px 0 0 0; overflow:hidden}
#advert1 .yjsquare_in{}
#tops, #bottoms{margin:15px 15px 0px 15px; text-align:center; padding:17px 7px 0 7px;height:1%; clear:both; overflow:hidden}
#bottoms{margin:10px 15px 5px 15px}
#user1, #user2, #user3, #user4, 
#user5, #user6, #user7, #user8{float:left; clear:right; text-align:left}
#tops .yjsquare, 
#bottoms .yjsquare{border:0; border-top:0; margin:0 10px 17px 10px; background:none; padding:0}
#tops .yjsquare_in, 
...
#tops .yjnf_descr, 
#bottoms .yjnf_descr{padding:0 0px; margin:0; font-size:11px}
#tops .yjnf_descr p, 
...
.yjnf_descr{padding:0 0px; margin:0; font-size:11px}
.yjnewsflash img{padding:0px; margin:-3px 5px 0px 0px; border:0; background:none}
.yjnf_descr{padding:0 0px; margin:-5px 0 0 0; font-size:11px}
...
.yjsquare_accslider{border-top:0; color:#E26F36; margin:0 0 0 0}
...
#tabs li{float:left; text-align:center; border-left:none; border-top:none; padding:0; height:58px!Important; cursor:pointer; font:italic bold 14px/43px "Times New Roman",Times,serif}
#tabs li.last, 
