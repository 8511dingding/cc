		...
		<div id="errorboxoutline">
			...
			<p>
				<ul>
                    ...
                    <li><a href="<?php echo $this->baseurl; ?>/blog/index.php" title="Go yo the blog">blog</a></li>
				</ul>
			</p>
			<p><?php echo JText::_('If difficulties persist, please contact the system administrator of this site.'); ?> mail@jianing.name</p>
			<div id="techinfo">
